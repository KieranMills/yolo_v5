...
#important code supressed
                        ...
                        print("x",round((c2[0]+c1[0])/2)-100,'y' ,round((c2[1]+c1[1])/3))
                        error = round((c2[0]+c1[0])/2)-100
                        errory = round((c2[1]+c1[1])/3)-100
                        e1 = round((c2[0]+c1[0])/2)-100
                        print(e1_old,e1)
                        #if round((c2[0]+c1[0])/2) > 110:
                            #move right
                        #    mouse.move(-0.5*error, 0)
                        #    print("right")
                        #    print('error', -0.8*error)
                    #    if round((c2[0]+c1[0])/2) < 100:
                        #    mouse.move(-0.5*error, 0)
                        #    print("left")
                        #    print('error', -0.8*error)
                            #left
                        if round((c2[1]+c1[1])/3) > 98:
                            #down
                            mouse.move(0, 4*errory)
                            print('down')
                        if round((c2[1]+c1[1])/3) < 85:
                            #up
                            mouse.move(0, errory)
                            print('up', 4*errory, "target", (c2[1]+c1[1])/3)

                        if round((c2[0]+c1[0])/2) > 105:
                            #move right
                            mouse.move(Kp*error+Kd*(e1-e1_old), 0)

                        if round((c2[0]+c1[0])/2) < 95:
                            mouse.move(Kp*error+Kd*(e1-e1_old), 0)
                            #left
